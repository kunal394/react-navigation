...
import { Animated, Image, Platform, StyleSheet, View, I18nManager, MaskedViewIOS, SafeAreaView } from 'react-native';
...
class Header extends React.PureComponent {
  ...
  _renderModularSubView(props,
    name,
    renderer, labelStyleInterpolator, buttonStyleInterpolator) {
    const { scene } = props;
